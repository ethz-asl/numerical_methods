...
g++ -I $CURRENT_PATH/include/ -I /usr/local/include/eigen3 $CURRENT_PATH/test/utility/test-incremental-statistics.cc /usr/lib/libgtest.a /usr/lib/libgtest_main.a -lglog -lpthread -o $CURRENT_PATH/bin/test-incremental-statistics -std=c++11